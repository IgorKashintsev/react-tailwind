  ...
  return (
    <div className='border border-t-0 border-gray-400 mb-8'>
      ...
      <div className='border-t border-b border-gray-400'>
        <h2 className='sm:-ml-52 mt-9 text-3xl font-bold text-center'>
          Welcome
        </h2>
        ...
        <div className='max-w-max mx-auto mt-6'>
          <button
            className='w-56 h-11 mb-6 rounded-md bg-sky-600 text-white text-xl font-medium'
            type='button'
          >
            See transactions
          </button>
      ...
      <p className='h-16 pt-3 bg-gray-100 text-center sm:text-2xl'>
